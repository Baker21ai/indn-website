...
export function AddDonorForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (formData.donorType === 'company' && !uploadedLogoUrl) {
      ...
      alert(error instanceof Error ? error.message : 'Failed to create donor. Please try again.')
    } finally {
      setIsSubmitting(false)
    }
  }
      ...
      <CardContent className="pt-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {isSubmitting ? 'Creating Donor...' : 'Create Donor'}
            </Button>
            <Button
              type="button"
              variant="outline"
