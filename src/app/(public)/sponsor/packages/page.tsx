...
export default function SponsorPackagesPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-charcoal via-charcoal to-charcoal/95 py-12 px-4 pt-24">
          ...
          <Card className="relative border-0 shadow-elevated overflow-hidden bg-white group hover:-translate-y-2 transition-all duration-300">
            ...
            <CardContent className="p-6 md:p-8">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-charcoal mb-1">Bronze</h2>
              ...
              >
                <Link href="/sponsor/apply" className="flex items-center justify-center gap-2">
          ...
          <Card className="relative border-0 shadow-elevated overflow-hidden bg-white group hover:-translate-y-2 transition-all duration-300">
            ...
            <CardContent className="p-6 md:p-8">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-charcoal mb-1">Silver</h2>
          ...
          <Card className="relative border-0 shadow-elevated overflow-hidden bg-white group hover:-translate-y-2 transition-all duration-300 md:-mt-4 md:mb-4">
            ...
            <CardContent className="p-6 md:p-8">
              <div className="text-center mb-6">
                ...
                <h2 className="text-3xl font-bold text-charcoal mb-1">Gold</h2>
